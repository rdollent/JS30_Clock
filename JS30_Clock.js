const t = new Date();
let mil = (t.getMilliseconds() * 0.006); //how many degrees in 1 mil
let sec = (t.getSeconds() * 6) + mil + 90; //how many degrees in 1 sec
let min = (t.getMinutes() * 6) + ((sec - mil - 90)/60) + (mil/60000) + 90;  //how many degrees in 1 min
let hr = t.getHours();
if (hr > 12) {
    hr = hr - 12;
}
